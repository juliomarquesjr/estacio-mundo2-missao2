...
/* Recebe a lista e monta no HTML */
showListItens = (list) => {
...
/* ### Funções de ordenações ### */

/* Seletor do select referente as ordenações */
selectOptions = () => {
...
/* Ordenador do tipo Selection Sort */
selection_sort = () => {
